  ...
  return (
    <Section variant="elevated" aria-labelledby="knee-pricing-heading">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-10 rounded-lg border border-border bg-surface overflow-hidden">
        ...
        <div className="mt-14">
          ...
          <ul className="mt-6 flex flex-wrap justify-center gap-3">
            {KNEE_REPLACEMENT_PRICING.factors.map((f) => (
              <li
                key={f}
                className="rounded-full border border-border bg-surface px-5 py-2 text-body-sm text-text-secondary"
              >
                {f}
              </li>
            ))}
